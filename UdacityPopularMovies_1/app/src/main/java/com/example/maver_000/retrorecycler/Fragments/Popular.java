...
import com.example.maver_000.retrorecycler.*;
 ...
 */
public class Popular extends Fragment implements Callback<MovieResponse>{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        movieAdapter=new MovieAdapter(getActivity(),getString(R.string.fragment_popular));
        ...
        if (savedInstanceState!=null){
            ...
            Call<MovieResponse> call = stackOverflowAPI.load_popular(getString(R.string.tmdb_api_key), 1);
            call.enqueue(this);
        }
    ...
    public void getmore(int offset){
        Retrofit retrofit=new Retrofit.Builder()
                ...
                .build();
        MovieAPI stackOverflowAPI = retrofit.create(MovieAPI.class);
        Call<MovieResponse> call = stackOverflowAPI.load_popular(getString(R.string.tmdb_api_key),offset);
        call.enqueue(this);
    ...
    public void onFailure(Throwable t) {
        if (mlist==null) {
            progressBar.setVisibility(View.GONE);
            Toast.makeText(getContext(), getString(R.string.toast_check_network), Toast.LENGTH_SHORT).show();
        }
    }
